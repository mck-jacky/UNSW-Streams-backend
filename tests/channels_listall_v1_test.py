# """
# Pytest for the channels_listall_v1() function.
# """
...
#         assert(channels_listall_v1('nonexistent_user'))
...
#     assert(type(channels_listall_v1(guser1)) is dict)

# def test_valid_user(clear_and_create_new_values):
#     """
#     If user not owner or member, but is a valid user.
#     Should return a dictionary matching expected_return.
#     """
...
#     assert(channels_listall_v1(user4["auth_user_id"]) == expected_return)

# def test_valid_user_no_channels(clear_and_create_new_values):
#     """
#     Input a valid user (user1 in this case), but there are no channels.
...
#     clear_v1()
#     user5 = auth_register_v1("e@mail5.com", "hunter5", "Padme", "Amidala")

#     assert(channels_listall_v1(user5["auth_user_id"]) == expected_return)
